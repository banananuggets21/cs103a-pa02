...
def small_DB(empty_db):
    transaction1 = {'item #': 3,'amount': 30, 'category': 'gaming', 'date': 20220522, 'description': '144hz monitor'}
    transaction2 = {'item #': 5,'amount': 20, 'category': 'pet supplies', 'date': 20220522, 'description': 'litter box'}
...
def test_addTransactions(small_DB):
    testTransaction = {'item #': 2,'amount': 96, 'category': 'toiletries', 'date': 20220522, 'description': 'toilet paper'}
...
def test_delete(small_DB):
    transactions0 = small_DB.select_all()
    transaction0 = {'item #': 5,'amount': 10, 'category': 'fruit', 'date': 20220522, 'description': 'banana'}
